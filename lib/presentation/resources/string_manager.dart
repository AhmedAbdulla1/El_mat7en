class AppStrings {
  static const String helloTitle = "مرحبا";

  static const String enter = "تسجيل الدخول";


  static const String email = 'البريد الالكتروني';
  static const String emailError = 'الرجاء ادخال البريد الالكتروني';
  static const String emailError2 = 'الرجاء ادخال بريد الكتروني صحيح';

  static const String password = 'الرقم السري';
  static const String passwordError1 ="الرجاء ادخال الرقم السري";
